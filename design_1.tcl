...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set RST_L [ create_bd_port -dir I -type rst RST_L ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $RST_L
  set sys_clk_i [ create_bd_port -dir I -type clk sys_clk_i ]
  set INIT_CALIB_WORKING [ create_bd_port -dir O -type data INIT_CALIB_WORKING ]
  set ETH_TXD [ create_bd_port -dir O -from 1 -to 0 ETH_TXD ]
  set ETH_TXEN [ create_bd_port -dir O ETH_TXEN ]
  set ETH_REFCLK [ create_bd_port -dir I ETH_REFCLK ]
  ...
  set_property CONFIG.C_USE_UART {0} $mdm_0
  ...
  set_property CONFIG.NUM_MI {5} $smartconnect_0
  ...
  # Create instance: ddr3_proc_sys_reset_1, and set properties
  set ddr3_proc_sys_reset_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 ddr3_proc_sys_reset_1 ]
  ...
  # Create instance: MII2RMII_0, and set properties
  set MII2RMII_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:MII2RMII:1.0 MII2RMII_0 ]

  # Create instance: eth_proc_sys_reset_0, and set properties
  set eth_proc_sys_reset_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 eth_proc_sys_reset_0 ]

  # Create instance: clk_wiz_1, and set properties
  set clk_wiz_1 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:6.0 clk_wiz_1 ]
  set_property -dict [list \
    CONFIG.CLKOUT1_JITTER {426.334} \
    CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {50.000} \
    CONFIG.MMCM_CLKOUT0_DIVIDE_F {15.875} \
  ...
  # Create instance: aresetn_h, and set properties
  set aresetn_h [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant:1.0 aresetn_h ]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M01_AXI [get_bd_intf_pins mig_7series_0/S_AXI] [get_bd_intf_pins smartconnect_0/M01_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M03_AXI [get_bd_intf_pins smartconnect_0/M03_AXI] [get_bd_intf_pins axi_ethernetlite_0/S_AXI]
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins axi_uartlite_0/S_AXI]

  # Create port connections
  connect_bd_net -net ETH_CRSDV_0_1  [get_bd_ports ETH_CRSDV] \
  [get_bd_pins MII2RMII_0/ETH_CRSDV]
  connect_bd_net -net ETH_REFCLK_0_1  [get_bd_ports ETH_REFCLK] \
  [get_bd_pins MII2RMII_0/ETH_REFCLK]
  connect_bd_net -net ETH_RXD_0_1  [get_bd_ports ETH_RXD] \
  [get_bd_pins MII2RMII_0/ETH_RXD]
  connect_bd_net -net MII2RMII_0_ETH_MDC  [get_bd_pins MII2RMII_0/ETH_MDC] \
  [get_bd_ports ETH_MDC]
  connect_bd_net -net MII2RMII_0_ETH_TXD  [get_bd_pins MII2RMII_0/ETH_TXD] \
  [get_bd_ports ETH_TXD]
  connect_bd_net -net MII2RMII_0_ETH_TXEN  [get_bd_pins MII2RMII_0/ETH_TXEN] \
  [get_bd_ports ETH_TXEN]
  connect_bd_net -net MII2RMII_0_mii_col  [get_bd_pins MII2RMII_0/mii_col] \
  [get_bd_pins axi_ethernetlite_0/phy_col]
  connect_bd_net -net MII2RMII_0_mii_crs  [get_bd_pins MII2RMII_0/mii_crs] \
  [get_bd_pins axi_ethernetlite_0/phy_crs]
  connect_bd_net -net MII2RMII_0_mii_rx_clk  [get_bd_pins MII2RMII_0/mii_rx_clk] \
  [get_bd_pins axi_ethernetlite_0/phy_rx_clk]
  connect_bd_net -net MII2RMII_0_mii_rx_dv  [get_bd_pins MII2RMII_0/mii_rx_dv] \
  [get_bd_pins axi_ethernetlite_0/phy_dv]
  connect_bd_net -net MII2RMII_0_mii_rx_er  [get_bd_pins MII2RMII_0/mii_rx_er] \
  [get_bd_pins axi_ethernetlite_0/phy_rx_er]
  connect_bd_net -net MII2RMII_0_mii_rxd  [get_bd_pins MII2RMII_0/mii_rxd] \
  [get_bd_pins axi_ethernetlite_0/phy_rx_data]
  connect_bd_net -net MII2RMII_0_mii_tx_clk  [get_bd_pins MII2RMII_0/mii_tx_clk] \
  [get_bd_pins axi_ethernetlite_0/phy_tx_clk]
  connect_bd_net -net MII2RMII_0_phy_mdio_i  [get_bd_pins MII2RMII_0/phy_mdio_i] \
  [get_bd_pins axi_ethernetlite_0/phy_mdio_i]
  connect_bd_net -net Net  [get_bd_ports ETH_MDIO] \
  [get_bd_pins MII2RMII_0/ETH_MDIO]
  connect_bd_net -net RST_L_1  [get_bd_ports RST_L] \
  [get_bd_pins ilvector_logic_0/Op1] \
  [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net SYS_CLK_1  [get_bd_ports sys_clk_i] \
  ...
  connect_bd_net -net axi_ethernetlite_0_phy_mdc  [get_bd_pins axi_ethernetlite_0/phy_mdc] \
  [get_bd_pins MII2RMII_0/phy_mdc_o]
  connect_bd_net -net axi_ethernetlite_0_phy_mdio_o  [get_bd_pins axi_ethernetlite_0/phy_mdio_o] \
  [get_bd_pins MII2RMII_0/phy_mdio_o]
  connect_bd_net -net axi_ethernetlite_0_phy_mdio_t  [get_bd_pins axi_ethernetlite_0/phy_mdio_t] \
  [get_bd_pins MII2RMII_0/phy_mdio_t]
  connect_bd_net -net axi_ethernetlite_0_phy_tx_en  [get_bd_pins axi_ethernetlite_0/phy_tx_en] \
  [get_bd_pins MII2RMII_0/mii_txd] \
  [get_bd_pins MII2RMII_0/mii_tx_en]
  ...
  connect_bd_net -net clk_in1_0_1  [get_bd_ports CLK12MHZ] \
  [get_bd_pins clk_wiz_0/clk_in1]
  connect_bd_net -net clk_wiz_0_clk_ref  [get_bd_pins clk_wiz_0/clk_ref] \
  [get_bd_pins mig_7series_0/clk_ref_i]
  connect_bd_net -net clk_wiz_1_clk_out1  [get_bd_pins clk_wiz_1/clk_out1] \
  [get_bd_pins eth_proc_sys_reset_0/slowest_sync_clk] \
  [get_bd_pins MII2RMII_0/clk]
  connect_bd_net -net clk_wiz_1_locked  [get_bd_pins clk_wiz_1/locked] \
  [get_bd_pins eth_proc_sys_reset_0/dcm_locked]
  connect_bd_net -net ddr3_proc_sys_reset_1_mb_reset  [get_bd_pins ddr3_proc_sys_reset_1/mb_reset] \
  [get_bd_pins microblaze_0/Reset] \
  [get_bd_pins microblaze_0_local_memory/SYS_Rst]
  connect_bd_net -net ddr3_proc_sys_reset_1_peripheral_aresetn  [get_bd_pins ddr3_proc_sys_reset_1/peripheral_aresetn] \
  [get_bd_pins axi_intc_0/s_axi_aresetn] \
  [get_bd_pins axi_ethernetlite_0/s_axi_aresetn] \
  [get_bd_pins smartconnect_0/aresetn] \
  [get_bd_pins axi_uartlite_0/s_axi_aresetn]
  connect_bd_net -net eth_proc_sys_reset_0_peripheral_reset  [get_bd_pins eth_proc_sys_reset_0/peripheral_reset] \
  [get_bd_pins MII2RMII_0/rst]
  connect_bd_net -net ilconcat_0_dout  [get_bd_pins ilconcat_0/dout] \
  [get_bd_pins axi_intc_0/intr]
  connect_bd_net -net ilconstant_0_dout  [get_bd_pins aresetn_h/dout] \
  [get_bd_pins mig_7series_0/aresetn]
  connect_bd_net -net ilvector_logic_0_Res  [get_bd_pins ilvector_logic_0/Res] \
  [get_bd_pins eth_proc_sys_reset_0/ext_reset_in] \
  [get_bd_pins ddr3_proc_sys_reset_1/ext_reset_in]
  connect_bd_net -net mig_7series_0_init_calib_complete  [get_bd_pins mig_7series_0/init_calib_complete] \
  [get_bd_pins ddr3_proc_sys_reset_1/dcm_locked] \
  [get_bd_ports INIT_CALIB_WORKING]
  connect_bd_net -net mig_7series_0_ui_clk  [get_bd_pins mig_7series_0/ui_clk] \
  [get_bd_pins ddr3_proc_sys_reset_1/slowest_sync_clk] \
  ...
  [get_bd_pins ddr3_proc_sys_reset_1/aux_reset_in]
  connect_bd_net -net rx_0_1  [get_bd_ports UART_RXD] \
