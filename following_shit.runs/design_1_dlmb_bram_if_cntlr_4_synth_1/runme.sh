...
HD_PWD='C:/Vivado_Projects/Vivado/following_shit/following_shit.runs/design_1_dlmb_bram_if_cntlr_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_dlmb_bram_if_cntlr_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_dlmb_bram_if_cntlr_4.tcl
