...
module design_1
   (CLK12MHZ,
    ...
    ddr3_sdram_we_n,
    sys_clk_i);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.CLK12MHZ CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.CLK12MHZ, CLK_DOMAIN design_1_clk_in1_0, FREQ_HZ 12000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input CLK12MHZ;
  input ETH_CRSDV;
  output ETH_MDC;
  inout ETH_MDIO;
  input ETH_REFCLK;
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.SYS_CLK_I CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.SYS_CLK_I, CLK_DOMAIN design_1_clk_in1_0, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) input sys_clk_i;
  ...
  wire axi_ethernetlite_0_phy_mdio_t;
  wire [3:0]axi_ethernetlite_0_phy_tx_data;
  ...
  wire [0:0]ddr3_proc_sys_reset_1_peripheral_aresetn;
  ...
  design_1_MII2RMII_0_0 MII2RMII_0
       (.ETH_CRSDV(ETH_CRSDV),
        ...
        .mii_txd(axi_ethernetlite_0_phy_tx_data),
        .phy_mdc_o(axi_ethernetlite_0_phy_mdc),
        .phy_mdio_i(MII2RMII_0_phy_mdio_i),
        .phy_mdio_o(axi_ethernetlite_0_phy_mdio_o),
        .phy_mdio_t(axi_ethernetlite_0_phy_mdio_t),
  ...
  design_1_axi_ethernetlite_0_0 axi_ethernetlite_0
       (.ip2intc_irpt(axi_ethernetlite_0_ip2intc_irpt),
        ...
        .s_axi_aresetn(ddr3_proc_sys_reset_1_peripheral_aresetn),
  ...
  design_1_proc_sys_reset_1_0 ddr3_proc_sys_reset_1
       (.aux_reset_in(mig_7series_0_ui_clk_sync_rst),
        ...
        .peripheral_aresetn(ddr3_proc_sys_reset_1_peripheral_aresetn),
  ...
  microblaze_0_local_memory_imp_1K0VQXK microblaze_0_local_memory
       (.DLMB_abus(microblaze_0_dlmb_1_ABUS),
        ...
        .SYS_Rst(ddr3_proc_sys_reset_1_mb_reset));
  ...
  design_1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aresetn(ddr3_proc_sys_reset_1_peripheral_aresetn));
endmodule
